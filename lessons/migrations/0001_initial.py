# Generated by Django 4.1.3 on 2022-12-08 16:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.IntegerField(choices=[(1, 'MRS'), (2, 'MR'), (3, 'MISS'), (4, 'MS')], default=1)),
                ('name', models.CharField(max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('reference_number', models.CharField(default=lessons.models.random_id, max_length=4, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Lessontype', to='lessons.lesson')),
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='request', to='lessons.student')),
                ('submit_depend_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='request_commit', to='lessons.student')),
            ],
        ),
        migrations.CreateModel(
            name='LessonBooking',
